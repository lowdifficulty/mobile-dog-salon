...
export default function StaffDialerPopup({
  ...
  return (
    <div
      className={`fixed z-[100] shadow-2xl overflow-hidden border border-green-600/30 bg-[#0f172a] text-white ${
        isLargeScreen
    ...
    >
      <div
        className={`flex items-center justify-between px-4 py-3 bg-gradient-to-r from-green-600 to-green-500 select-none ${
