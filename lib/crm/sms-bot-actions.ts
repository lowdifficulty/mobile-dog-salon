...
export async function smsBookSlot(
  ...
  return {
    ...
    message: `You're booked! ${result.appointment.petName || "Your pup"} — ${formatAppointmentWhen(result.appointment.startAt)} with ${groomerName(result.appointment.groomerId)}. Manage visits: ${companyLegal.siteUrl}/my-appointment`,
  };
}
